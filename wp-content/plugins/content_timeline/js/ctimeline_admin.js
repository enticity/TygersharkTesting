...
//not working on mozilla firefox!!!
        ...
        var openCardLeftPosition = 0.52 * $('body').width();
        var openCardTopPosition = 0.7 * $('body').height();
        ...
        $(document).on('click', '.tsort-change', function(e) {
            ...
            file_frame.on( 'select', function() {
                ...
                console.log(images[0].changed.url);
				...
				/*  image_data = file_frame.state().get( 'selection' ).toJSON();*/
				...
				/* $(document).find('.TBct_card_window').css('z-index', 10000000);*/
        ...
        $('#preview-timeline').click(function(e){
            ...
            html += '<div id="TBct_window" style="width:250px; margin-left:-75px; height:80px; margin-top:-40px; visibility: visible; letter-spacing:0.1px;">';
