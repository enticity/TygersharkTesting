                            ...
                            if (isset($timeline) && $timeline->items != '') {
                                ...
                                foreach ($itemsArray as $key => $arr) {
                                    ...
                                    <li id="<?php echo $key; ?>" class="sortableItem" data-copy-counter="1">
                                        ...
                                        <div class="TBct_card_window" style="width:52vw; height:70vh; opacity:0;">
                                                    ...
                                                    <div class="item-info-wrapper">
                                                        ...
                                                        <table style="width:100%; margin-bottom: 9px; border-spacing: 0px 4px;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input class="tsort-link" name="<?php echo $key; ?>-item-link" placeholder="http://..." value="<?php echo (isset($arr['item-link']) ? $arr['item-link'] : ''); ?>" type="text" style="width:91%;" /></td>
                                                            </tr>
                                                        </table>
                                                        <table style="width:100%; margin-bottom: 9px; border-spacing: 0px 4px;">
                                                            <tr>
                                                                ...
                                                                <td><span class="timeline-help dashicons dashicons-editor-help" style="margin-top: -1px;"><span class="timeline-tooltip">Category that the post belongs to</span></span><label style="margin-left:7px; font-size:14px; font-weight:bold;" for="<?php echo $key; ?>-categoryid">CATEGORY:</label></td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td><input style="width:91%;" id="<?php echo $key; ?>-categoryid" name="<?php echo $key; ?>-categoryid" placeholder="Blog posts..." value="<?php echo $arr['categoryid']; ?>" class="category_id" type="text"/></td>
                                                            </tr>
                                                        </table>
											...
											<input style="margin-left:5px;" id="<?php echo $key; ?>-categoryid" name="<?php echo $key; ?>-categoryid" placeholder="Blog posts..." value="<?php echo $arr['categoryid']; ?>" class="category_id" type="text"/>
                                                </div>-->
